module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            ...
            2,
            b"nguyennthanh9092", 
            b"nguyennthanh9092 FAUCET",
            b"DAY LA COIN FAUCET CUA nguyennthanh9092",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/193947064?v=4")),
            ctx
        );
