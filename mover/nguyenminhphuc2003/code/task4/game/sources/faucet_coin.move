module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            witness,
            2,
            b"nguyenminhphuc2003", 
            b"nguyenminhphuc2003 FAUCET",
            b"DAY LA COIN FAUCET CUA nguyenminhphuc2003",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/198553178?v=4")),
            ctx
        );
