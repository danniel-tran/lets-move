module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            ...
            2,
            b"truongthanhtai2k3", 
            b"TRUONG THANH TAI FAUCET",
            b"DAY LA COIN FAUCET CUA TRUONG THANH TAI",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/198735603?v=4")),
            ctx
        );
