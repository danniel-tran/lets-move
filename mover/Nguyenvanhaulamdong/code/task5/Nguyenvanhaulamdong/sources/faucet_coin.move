module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            witness,
            2,
            b"Nguyenvanhaulamdong", 
            b"Nguyenvanhaulamdong FAUCET",
            b"DAY LA COIN FAUCET CUA Nguyenvanhaulamdong",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/197501448?v=4")),
            ctx
        );
