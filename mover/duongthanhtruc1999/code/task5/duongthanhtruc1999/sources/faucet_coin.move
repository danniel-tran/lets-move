module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            witness,
            2,
            b"duongthanhtruc1999", 
            b"DUONGTHANHTRUC1999 FAUCET",
            b"DAY LA COIN FAUCET CUA DUONG THANH TRUC",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/198570282?v=4")),
            ctx
        );
