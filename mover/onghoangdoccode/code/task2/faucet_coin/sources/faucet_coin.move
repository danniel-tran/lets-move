module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            ...
            2,
            b"onghoangdoccode", 
            b"onghoangdoccode FAUCET",
            b"DAY LA COIN FAUCET CUA ONG HOANG DOC CODE",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/198489366?v=4")),
            ctx
        );
