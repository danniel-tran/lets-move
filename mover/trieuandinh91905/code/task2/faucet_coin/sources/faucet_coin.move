module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            ...
            2,
            b"trieuandinh91905", 
            b"TRIEUANDINH91905 FAUCET",
            b"DAY LA COIN FAUCET CUA TRIEUANDINH91905",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/198200269?v=4")),
            ctx
        );
