module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            ...
            2,
            b"phamthaihongphuoc", 
            b"PHAMTHAIHONGPHUOC FAUCET",
            b"DAY LA COIN FAUCET CUA PHAMTHAIHONGPHUOC",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/198185154?v=4")),
            ctx
        );
