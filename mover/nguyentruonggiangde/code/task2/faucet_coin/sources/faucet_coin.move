module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            witness,
            2,
            b"nguyentruonggiangde", 
            b"NGUYEN TRUONG GIANG FAUCET",
            b"DAY LA COIN FAUCET CUA NGUYEN TRUONG GIANG",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/199132095?v=4")),
            ctx
        );
