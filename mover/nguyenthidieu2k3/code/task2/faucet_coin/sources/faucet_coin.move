module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            ...
            2,
            b"nguyenthidieu2k3", 
            b"nguyenthidieu2k3 FAUCET",
            b"DAY LA COIN FAUCET CUA nguyenthidieu2k3",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/193950315?v=4")),
            ctx
        );
