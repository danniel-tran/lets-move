module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            witness,
            2,
            b"nguyenthebinhcoder", 
            b"NGUYENTHEBINHCODER FAUCET",
            b"DAY LA COIN FAUCET CUA BINH CODER",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/199131464?v=4")),
            ctx
        );
