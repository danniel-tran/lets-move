module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            ...
            2,
            b"sonhoangnguyen2k2", 
            b"sonhoangnguyen2k2 FAUCET",
            b"DAY LA COIN FAUCET CUA SON HOANG NGUYEN",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/193554648?v=4")),
            ctx
        );
