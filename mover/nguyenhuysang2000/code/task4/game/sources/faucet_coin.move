module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            ...
            2,
            b"nguyenhuysang2000", 
            b"nguyenhuysang2000 FAUCET",
            b"DAY LA COIN FAUCET CUA nguyenhuysang2000",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/198892304?v=4")),
            ctx
        );
