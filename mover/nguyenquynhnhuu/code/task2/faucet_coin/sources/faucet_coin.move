module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            ...
            2,
            b"nguyenquynhnhuu", 
            b"NGUYEN QUYNH NHU FAUCET",
            b"DAY LA COIN FAUCET CUA NGUYEN QUYNH NHU",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/198568476?v=4")),
            ctx
        );
