module 0x0::faucet_coin {
    ...
    fun init(witness: FAUCET_COIN, ctx: &mut TxContext) {
        let (treasury, metadata) = coin::create_currency(
            ...
            2,
            b"vohoangcuong1998", 
            b"VOHOANGCUONG1998 FAUCET",
            b"DAY LA COIN FAUCET CUA VOHOANGCUONG1998",
            some(url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/198186107?v=4")),
            ctx
        );
